...
export function EditStudentForm({ onSuccess, student, open, setOpen }) {
  ...
  useEffect(() => {
    ...
    const data = {
      ...
      monthlyFee: student.monthlyFee
        ...
        : "",
      monthlyFeeDisplay: student.monthlyFee
        ...
        : "",
      dueDay: student.dueDay?.toString() || "",
    };
  ...
  async function handleSubmit() {
    ...
    try {
      ...
      toaster.create({
        title: "Não foi possível editar o aluno.",
        type: "error"
      })
    } finally {
      setIsLoading(false)
